...
{
    public class EFCountDownWriteRepository : GenericWriteRepository<CountDown>, ICoutDownWriteDal
    {
        public EFCountDownWriteRepository(DjozContext context) : base(context)
        {
        }
    }
}
